...
# With margins=True every amount appears 4 times: its cell + row total
# + column total + grand total -> naive sum = 4 x 1390 = 5560.
...
naive = int(p1.to_numpy().sum())
print("     naive sum of all pivot cells =", naive,
      f"(= {naive // grand} x grand total, counted 4 times - wrong)")
